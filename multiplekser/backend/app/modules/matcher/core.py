...
from app.modules.parser import core_and_attrs, core_and_attrs_hydraulika, dice_coeff
...
__all__ = [
    ...
    "match_against_catalog", "match_against_catalog_hydraulika",
    "resolve_by_kod", "apply_warehouse_variant", "magazyn_key",
]
...
def match_against_catalog_hydraulika(
    ...
    """Odpowiednik match_against_catalog() dla dzialu Hydraulika - OSOBNA funkcja, nie
    wspolny silnik generyczny (swiadoma decyzja, ta sama co w parser/hydraulika.py: zestaw
    atrybutow jest fundamentalnie inny - gwint/material/zlacze zamiast kraj/kolor/montaz/faza
    - wspolny silnik konfiguracji per dzial (AttributeRule) byl rozwazany i odrzucony na rzecz
    zachowania tego samego stylu co juz istniejacy special_rules.py, patrz commit message).
    Wspolna warstwa: resolve_by_kod/apply_warehouse_variant/_alias_hits/dice_coeff/MatchResult -
