"""API produktow (Etap 4) - pelny CRUD, sesja DB wstrzykiwana per-request przez Depends(get_db)."""
...
@router.get("/{kod}", response_model=ProductOut)
...
@router.put("/{kod}", response_model=ProductOut)
