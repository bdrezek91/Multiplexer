...
# Realny przypadek produkcyjny (2026-09-10): odreczny slad (cyfra "100") lezal fizycznie na
# wysokosci wiersza-etykiety "INNE:" (separator sekcji, nie prawdziwa pozycja) - model zwrocil
# pozycje o nazwie doslownie "INNE" z iloscia 100, ktora matcher (fuzzy dopasowanie tekstu) w
# koncu dopasowal do przypadkowego, bezsensownego produktu ("Oprawa panel LED BLINGO 120X30").
# Wczesniejsza instrukcja mowila tylko o pomijaniu PUSTYCH wierszy sekcji INNE, nie zabraniala
# wprost zwracania SAMEJ etykiety naglowka jako nazwy pozycji, gdy przypadkowo znalazl sie przy
# niej jakikolwiek slad.
_NAGLOWEK_JAKO_POZYCJA_DOPISEK = (
    ' NIGDY NIE ZWRACAJ ETYKIETY JAKO POZYCJI: "INNE:" i inne etykiety naglowkow/sekcji '
    '(np. "Elektryka", "Pracownik", "Numer Projektu", "Wymiar", "Kraj", "Nr Plomby-rozdzielnia", '
    'naglowki kolumn "Ilość Wydana"/"Ilość zużyta"/"Jednostka") to STRUKTURA formularza, NIGDY '
    'nazwa materialu - nawet jesli w tej samej linii co taka etykieta widac jakakolwiek cyfre '
    'lub inny slad. Taki slad NIE NALEZY do etykiety: sprawdz, czy nie jest to w rzeczywistosci '
    'wartosc z sasiedniego, prawdziwego wiersza tabeli (nad lub pod etykieta) - jesli tak, '
    'przypisz go do TEGO wlasciwego wiersza. Jesli nie da sie jednoznacznie ustalic, do ktorego '
    'wiersza slad nalezy - pomin go calkowicie, nigdy nie zwracaj pozycji, ktorej "nazwa" to sama '
    'etykieta naglowka/sekcji.'
)
